...
public:
    ...
    // 名字管理
    [[nodiscard]] STextView getName() const noexcept { return _name; }
    [[nodiscard]] SString  getRefName() const noexcept { return _name.data(); }
    void                    setName(STextView name) { _name = name; }
