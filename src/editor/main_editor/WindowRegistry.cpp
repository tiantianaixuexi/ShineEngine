...
namespace shine::editor::main_editor
{
    ...
    void WindowRegistry::Init(MainEditor* commands)
    {
        ...
        auto* scriptSystem = ctx.GetSystem<script::ScriptSystem>();
        ...
        editorView_->SetWorldHierarchyService(worldHierarchyService);
        editorView_->onInit();
    ...
    void WindowRegistry::Render(bool& mainDocker)
    {
        ...
        ImGui::PopStyleVar(2);
        ImGuiID mainDockId = ImGui::GetID("EngineMainDock");
    ...
    bool WindowRegistry::ToggleDebugTexture()
    {
        return debugTextureView_->SetShow();
    }
