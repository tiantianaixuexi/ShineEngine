...
namespace shine::manager
{
    ...
    {
        bridge.RegisterRuntimeLoader(shine::editor::asset::EEditorAssetType::Texture,
        ...
        bridge.RegisterRuntimeLoader(shine::editor::asset::EEditorAssetType::StaticMesh,
            [](manager::IAssetImportPipeline& assetManager, const std::string& path) -> std::expected<manager::AssetHandle, std::string>
            {
        ...
        bridge.RegisterRuntimeLoader(shine::editor::asset::EEditorAssetType::Scene,
            [](manager::IAssetImportPipeline& assetManager, const std::string& path) -> std::expected<manager::AssetHandle, std::string>
            {
